...
export const REDELEGATION_LOCK_SELECTOR =
  "0xc9fb5027edad04dc7cbd44766b39dcb7d42c498b3b47b80001805039c63cf1e0";
...
export function getRewardDelegatorAddress(
  clusterRewardsAddress: Address
): Address {
  if (
    clusterRewardsAddress.equals(
      Address.fromString("0xA83aD48E2c963a2dF6adcC710Ba520a97d237dCc")
    )
  ) {
    return Address.fromString("0x802E91F47e09E23eB253Ffcc97665497e12ec93D");
  } else if (
    clusterRewardsAddress.equals(
      Address.fromString("0x5124324e4f185C55dff566A71d8666fEf0297cd7")
    )
  ) {
    return Address.fromString("0x513FB60037240205A0CF17C260257097D747BD46");
  } else if (
    clusterRewardsAddress.equals(
      Address.fromString("0x871ed48eC1784b1d27BD086765F54E1f8f484e66")
    )
  ) {
